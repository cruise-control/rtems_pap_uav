...
../arch/sim/mcu_periph/spi_arch.c \
../arch/sim/mcu_periph/sys_time_arch.c 

OBJS += \
./arch/sim/mcu_periph/adc_arch.o \
./arch/sim/mcu_periph/i2c_arch.o \
./arch/sim/mcu_periph/spi_arch.o \
./arch/sim/mcu_periph/sys_time_arch.o 

C_DEPS += \
./arch/sim/mcu_periph/adc_arch.d \
./arch/sim/mcu_periph/i2c_arch.d \
./arch/sim/mcu_periph/spi_arch.d \
./arch/sim/mcu_periph/sys_time_arch.d 


# Each subdirectory must supply rules for building sources it contributes
arch/sim/mcu_periph/%.o: ../arch/sim/mcu_periph/%.c
	@echo 'Building file: $<'
