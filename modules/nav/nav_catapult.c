...
//SC
#ifndef NAV_CATAPULT_HIGHRATE_MODULE_FREQ
#define NAV_CATAPULT_HIGHRATE_MODULE_FREQ 30
#endif
...
bool_t nav_catapult_run(uint8_t _to, uint8_t _climb)
{
  ...
  else
  {
    ...
    //SC error: 'Ethernet' undeclared - something to do with the ethernet transport...
